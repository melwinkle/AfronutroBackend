...
from .views import DietaryAssessmentRetrieveView, DietaryAssessmentView, RegisterView,ResendVerificationEmailAPIView,VerifyEmailAPIView, LoginView, ProfileView,LogoutView,ChangePasswordView,PasswordResetRequestAPIView, PasswordResetConfirmAPIView,EducationalContentListCreateView,EducationalContentDetailView,EducationalContentByTypeView,RecalculateAssessmentView,ActivityLevelView,HealthGoalView,DietaryPreferenceView
